...
namespace YelpAPI
{
    ...
    class YelpAPIClient
    {
        ...
        /// </summary>
        private const string CONSUMER_KEY = "Ul698aSdCvU74-dSBecWng";

        /// <summary>
        /// Consumer secret used for OAuth authentication.
        /// This must be set by the user.
        /// </summary>
        private const string CONSUMER_SECRET = "Gc-jgopthbjB2c8_dzRzxL3pneE";

        /// <summary>
        /// Token used for OAuth authentication.
        /// This must be set by the user.
        /// </summary>
        private const string TOKEN = "hAnbTwZ7lV5ZvE8J-WjRlc4vZCVF9i3F";

        /// <summary>
        /// Token secret used for OAuth authentication.
        /// This must be set by the user.
        /// </summary>
        private const string TOKEN_SECRET = "-EWmqyVvl-XIwVVS7eLmsL0YPxw";
        ...
        /// <returns>The JSON response from the API.</returns>
        public JObject Search(string term, string location, string offset)
        {
    ...
    class Program
    {
        ...
        public static int QueryAPIAndPrintResult(string term, string location, string offset)
        {
            int found = 0;
            ...
            JObject response = client.Search(term, location, offset);

            JArray businesses = (JArray)response.GetValue("businesses");

            found = businesses.Count;
            ...
            {
                string id = (string) business["id"];
                response = client.GetBusiness(id);
                Console.WriteLine(String.Format("Result for business {0} found:", id));
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                do
                {
                    found = Program.QueryAPIAndPrintResult(options.Term, options.Location, offset.ToString());
                    offset += found;
                } while (found > 0);
